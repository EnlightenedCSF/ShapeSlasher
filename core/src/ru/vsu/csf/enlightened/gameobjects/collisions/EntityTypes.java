...
public class EntityTypes {
    ...
    public static final short ENEMY_SWORD       = 0x80;   // 1 0 0 0 | 0 0 0 0

    public static final short GROUND_MASK       = 0x3a;   // 0 0 1 1 | 1 0 1 0
    public static final short HERO_MASK         = 0xC9;   // 1 1 0 0 | 1 0 0 1
    public static final short SWORD_MASK        = 0xA;    // 0 0 0 0 | 1 0 0 0
    ...
    public static final short ENEMY_SWORD_MASK  = 0xF;    // 0 0 0 0 | 0 0 1 0
}